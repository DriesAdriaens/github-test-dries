...
```
Histogram op basis van de diepte van de filters van de grondwatermeetpunten (`loc_type == "P"`) :
```{r}
locaties %>% 
  ggplot() +
...
De maximale filterdiepte bedraagt 2.94m.

# Raaien

In de vallei van de Mombeek liggen de meetpunten gegroepeerd in 3 raaien, dwars georiënteerd op de Mombeek. Eén meetpunt ligt geïsoleerd in het oosten.
...
Uit dat lijstje blijkt dat de stijghoogten in de drie westelijk gelegen raaien telkens in meerdere meetpunten boven maaiveld liggen.
...
We bekijken hieronder de tijdreeksen voor elk van deze raaien in meer detail. 
...
<!-- Eventueel nog (langere) meetreeksen bekijken van meetstations L09_16G en L09_167 op resp. Oude Mombeek en Mombeek, gelegen tussen raai 2 en 3 ter hoogte van de monding van de Melbeekgracht in de Mombeek? -->
...
Alle metingen? Met uitsluiting van MOMP001 vanwege vermoedelijke kweldruk aan rand van vallei?
