...
ggplot(tijdreeks %>% 
  ...
  ## non-clipping zoom
  coord_cartesian(ylim = c(31.5, 34.25),
                  xlim = c(ymd("2017-01-01"), ymd("2020-01-01"))
                  ) +
  scale_x_date(date_breaks = "year", date_labels = "%Y") +
  ## clipping zoom
  # xlim(ymd("2017-01-01"), ymd("2020-01-01")) +
...
Selectie van metingen: alle metingen? Met uitsluiting van MOMP001 vanwege vermoedelijke kweldruk aan rand van vallei? MOMP009 ook uit de selectie laten?

# To do

* Hoe gevalideerde sondemetingen wegfilteren met afwijkende metingen (cfr. peilmetingcategorieën bij handmatige metingen)?
* Valideren van ontbrekende metingen voor 2020 (nu veelal metingen t.e.m. 09/2019)

Tabel met kenmerken van metingen per meetpunt, gesorteerd volgens transect, y-coördinaat, meetpunt:
