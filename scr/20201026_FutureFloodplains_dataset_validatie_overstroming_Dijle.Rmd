...
ggplot(komgr_egenhoven_tijdreeks %>% 
  ...
  labs(x = "Datum", y = "mTAW", colour = NULL, linetype = NULL)
```
De pieken in de grondwatermeetpunten komen mooi overeen met de pieken in de oppervlaktewaterpeilen van zowel de Dijle als de Langestaart. Na de aanleg van het stuw op de Dijle en zandvang in Egenhoven (2015?), lijkt die relatie verbroken. Er zijn evenwel te weinig grondwatermeetgegevens om hierover een uitspraak te kunnen doen.
