...
tussen waterlopen Grens Van Oud-Heverlee en Vaalbeek/Molenbeek, ten oosten van Dijle; gedraineerd door Leibeek
...
```{r}
komgr_doodebeemde_loc_vec <- c("BAOL502", "DYLR003", "DYLP075", "DYLP041", "DYLB039", "DYLB093", "DYLP024", "DYLP040", "DYLP007", "DYLP008", "DYLP009", "DYLP015", "DYLP017", "DYLP022", "DYLP039", "DYLP054", "DYLP059", "DYLP062", "DYLP063", "DYLP074", "DYLP091", "DYLP092", "DYLP093", "DYLS003", "DYLS004", "DYLP016", "DYLP004", "DYLP006", "DYLP042", "DYLP055", "DYLP023")
```
...
Alle `r aantal_doodebeemde` van de `r length(komgr_doodebeemde_loc_vec)` meetpunten in de komgrond van de Doode Beemde hebben dus stijghoogte die ooit eens boven maaiveld gelegen hebben.
...
ggplot(komgr_doodebeemde_tijdreeks %>% 
  ...
  labs(x = "Datum", y = "m-mv", colour = NULL)
```
Tijdreeksen voor meetpunten met gemeten stijghoogten hoger dan 25 cm boven maaiveld:
...
Uit de metadata van de peilbuizen in de komgrond van de Doode Beemde blijkt dat alle peilbuizen minder dan 3 m diep zijn. Op basis van de analyse van de peilbuiskoppels in de komgrond van Neerijse, is het aannemelijk dat in de peilbuizen geen kweldrukken geregistreerd worden.

Hieronder een histogram van de peilbuisdiepten.

To do:
* check voor eventueel aanwezige peilbuiskoppels (via x/y coördinaten?)
